...
function loadMore() {
    ...
    $.getJSON('/ota/api/v1/changes/' + device + '/' + lastChangeTime + '/', null, function(data, textStatus, xhr) {
...
$(document).ready(function() {
    ...
    $.getJSON('/ota/api/v1/' + device + '/nightly/changelog', null, function(data, textStatus, xhr) {
